...
SECRET_KEY = 'django-insecure-)2ig!@=6v+4)!*j*e6pq(92m7c3p-h#u_78pblh(#2522m281$'
...
# Настройки для загружаемых файлов (аватары, картинки в постах)
MEDIA_URL = 'media/'
...
# Куда перенаправлять после входа (если нет параметра next)
LOGIN_REDIRECT_URL = '/'
