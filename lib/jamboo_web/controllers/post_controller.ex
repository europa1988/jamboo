defmodule JambooWeb.PostController do
  ...
  def show(conn, %{"id" => id}) do
    ...
    comment_changeset = Comments.change_comment(%Jamboo.Comments.Comment{})
    render(conn, :show, post: post, comments: comments, comment_form: to_form(comment_changeset))
  end
  ...
  def upvote(conn, %{"id" => id}) do
    ...
    conn
    |> put_layout(false)
    |> render("render_post_vote.html", post: post)
  end
