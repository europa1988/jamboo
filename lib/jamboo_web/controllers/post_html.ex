  ...
  def post_vote(assigns) do
    ...
    <div class="flex flex-col items-center space-y-1 vote-container">
      <button
        ...
        title={gettext("Повысить рейтинг")}
      >
        <.icon name="hero-arrow-up-solid" class="size-6 text-gray-600 hover:text-orange-500" />
      </button>
      ...
      <button
        ...
        hx-swap="outerHTML"
        class="p-2 hover:bg-gray-100 rounded-full transition-colors"
        title={gettext("Понизить рейтинг")}
      >
        <.icon name="hero-arrow-down-solid" class="size-6 text-gray-600 hover:text-blue-500" />
      </button>
    </div>
    """
  end
